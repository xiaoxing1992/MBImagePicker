...
public final class PictureSelectionConfig implements Parcelable {
    public boolean isShowChooseNumber;
    public boolean isShowSelectBottomLayout;
    ...
    protected void initDefaultValue() {
        isShowChooseNumber = true;
        isShowSelectBottomLayout = true;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeByte(this.isShowChooseNumber ? (byte) 1 : (byte) 0);
        dest.writeByte(this.isShowSelectBottomLayout ? (byte) 1 : (byte) 0);
    ...
    protected PictureSelectionConfig(Parcel in) {
        this.isShowChooseNumber = in.readByte() != 0;
        this.isShowSelectBottomLayout = in.readByte() != 0;
