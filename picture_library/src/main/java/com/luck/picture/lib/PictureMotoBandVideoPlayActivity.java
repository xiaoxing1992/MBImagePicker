 ...
 * @描述: 视频播放类
 */
public class PictureMotoBandVideoPlayActivity extends PictureBaseActivity implements
    ...
    public int getResourceId() {
        return R.layout.picture_activity_motoband_video_play;
    }
    ...
    protected void initPictureSelectorStyle() {
        if (PictureSelectionConfig.uiStyle != null) {
            if (PictureSelectionConfig.uiStyle.picture_top_titleRightTextColor.length > 0) {
                ...
                tvConfirm.setTextColor(ContextCompat.getColor(getContext(), R.color.picture_color_white));
            }
