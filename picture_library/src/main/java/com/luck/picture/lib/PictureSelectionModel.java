...
public class PictureSelectionModel {
    ...
    public PictureSelectionModel isShowChooseNumber(boolean flag) {
        selectionConfig.isShowChooseNumber = flag;
        return this;
    }

    public PictureSelectionModel isShowSelectBottomLayout(boolean flag) {
        selectionConfig.isShowSelectBottomLayout = flag;
        return this;
    }
}
